...
// THIS FILE MUST RUN IN FOLDER
// custom/{tenant}/pms/rms/
...
if (check_account_exist($kiw_db, $kiw_username_db, $_SESSION['controller']['tenant_id']) == false){
    ...
    $headers = [
        'client_id:01793a7cc8be49c19e0eb1a88d91495b',
        'client_secret:515a4F3E1b5344378ee457A0b325cd01',
    ...
    curl_setopt($kiw_auth, CURLOPT_URL, "https://api-uat.capitaland.com/dev/group/channel/common/v1/getstatus");
