...
go(function () {
    ...
    $kiw_get_profiles = $kiw_db->query("SELECT * FROM kiwire_auto_reset WHERE tenant_id = '{$kiw_cloud['tenant_id']}' AND exec_when = 'cw'");
    ...
    if (empty($kiw_get_profiles)) die();
        ...
        foreach ($kiw_profiles as $kiw_profile) {
            ...
            foreach ($kiw_accounts as $kiw_account) {
                ...
                $kiw_date["renew"] = date("Y-m-d 00:00:00", strtotime("+7 Day", strtotime($kiw_account['date_activate'])));
