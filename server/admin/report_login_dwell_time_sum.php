    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="login_dwell_sum_title">Login Dwell Time</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="login_dwell_sum_subtitle">
                                Information on average dwell time of user
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="login_dwell_sum_no">No</th>
                                        <th data-i18n="login_dwell_sum_date">Date</th>
                                        <th data-i18n="login_dwell_sum_total_login">Total Login</th>
                                        <th data-i18n="login_dwell_sum_average_dwell">Average Dwell Time ( Hour : Minute : Second )</th>
                                        <th data-i18n="login_dwell_sum_detail_view">Detail View</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel16" data-i18n="login_dwell_sum_modal_title">Login Dwell Time - Detail</h4>
            ...
            <div class="modal-body" style="overflow: auto;">
                ...
                <table class="table table-hover table-detail">
                    <thead class="thead thead-light">
                        <tr>
                            <th data-i18n="login_dwell_sum_modal_no">No</th>
                            <th data-i18n="login_dwell_sum_modal_type">Dwell Type</th>
                            <th data-i18n="login_dwell_sum_modal_time">Dwell Time</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
            ...
            <div class="modal-footer">
                <button class="btn btn-danger waves-effect waves-light" data-dismiss="modal" data-i18n="login_dwell_sum_modal_close">Close</button>
            </div>
                                ...
                                <form class="form form-vertical">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <button type="button" id="filter-data" class="btn btn-primary round mr-1 mb-1 waves-effect waves-light pull-right" data-i18n="login_dwell_sum_modal_filter">Filter</button>
