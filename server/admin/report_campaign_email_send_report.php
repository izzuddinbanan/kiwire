    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="camp_email_report_title">Email Send Report</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="camp_email_report_subtitle">
                                Information on email send
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6">
                <div class="card text-white bg-gradient-primary">
                    <div class="card-content d-flex">
                        <div class="card-body">
                            <h5 class="text-white" id="total-email" style="font-size: xx-large; font-weight: bolder;">0</h5>
                            <h5 class="text-white" data-i18n="camp_email_report_email_sent">TOTAL EMAIL SENT</h5>
                            <p class="card-text" style="font-size: smaller;" data-i18n="camp_email_report_between_dates">BETWEEN THESE 2 DATES</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6">
                <div class="card text-white bg-gradient-primary">
                    <div class="card-content d-flex">
                        <div class="card-body">
                            <h5 class="text-white" id="avg-email" style="font-size: xx-large; font-weight: bolder;">0</h5>
                            <h5 class="text-white" data-i18n="camp_email_report_average_email">AVERAGE EMAIL SENT</h5>
                            <p class="card-text" style="font-size: smaller;" data-i18n="camp_email_report_hourly_dates">HOURLY BETWEEN THESE 2 DATES</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="camp_email_report_no">No</th>
                                        <th data-i18n="camp_email_report_date">Date</th>
                                        <th data-i18n="camp_email_report_total_email">Total Email</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group" style="position:relative; left:auto; display:block;">
                                                    <label for="startdate" data-i18n="camp_email_report_modal_date_from">Date From</label>
                                                    <input type="text" class="form-control format-picker" name="startdate" id="startdate" value='<?= report_date_view(report_date_start("", 2)) ?>'>
                                                </div>

                                                <div class="form-group" style="position:relative; left:auto; display:block;">
                                                    <label for="enddate" data-i18n="camp_email_report_modal_date_until">Date Until</label>
                                                    <input type="text" class="form-control format-picker" name="enddate" id="enddate" value='<?= report_date_view(report_date_start("", 1)) ?>'>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <button type="button" id="filter-data" class="btn btn-primary round mr-1 mb-1 waves-effect waves-light pull-right" data-i18n="camp_email_report_modal_filter">Filter</button>
                                                <button type="reset" class="btn btn-danger round mr-1 mb-1 waves-effect waves-light pull-right" data-dismiss="modal" data-i18n="camp_email_report_modal_cancel">Cancel</button>
                                            </div>
