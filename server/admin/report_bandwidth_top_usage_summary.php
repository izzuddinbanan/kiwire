    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="bandwidth_top_usage_title">Top Bandwidth Usage Summary</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="bandwidth_top_usage_subtitle">
                                Information on historic top bandwidth users
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="card-text">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="type" data-i18n="data_type">Type</label>
                                    <select class="form-control" name="type" id="type">
                                        <option value="download" data-i18n="bandwidth_top_usage_option_download">Download</option>
                                        <option value="upload" data-i18n="bandwidth_top_usage_option_upload">Upload</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover table-data">
                                ...
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="bandwidth_top_usage_no">No</th>
                                        <th data-i18n="bandwidth_top_usage_login_time">Login Time</th>
                                        <th data-i18n="bandwidth_top_usage_username">Username</th>
                                        <th data-i18n="bandwidth_top_usage_usage_time">Usage Time</th>
                                        <th data-i18n="bandwidth_top_usage_ipaddress">IP Address</th>
                                        <th data-i18n="bandwidth_top_usage_mac_address">Mac Address</th>
                                        <th><span data-i18n="bandwidth_top_usage_download">Download</span> ( <?= $_SESSION['metrics'] ?> )</th>
                                        <th><span data-i18n="bandwidth_top_usage_upload">Upload</span> ( <?= $_SESSION['metrics'] ?> )</th>
                                        <th><span data-i18n="bandwidth_top_usage_average_download">Average Download</span> ( <?= $_SESSION['metrics'] ?>ps ) </th>
                                        <th><span data-i18n="bandwidth_top_usage_average_upload">Average Upload</span> ( <?= $_SESSION['metrics'] ?>ps ) </th>
                                    </tr>
                                </thead>

                                <tbody>
                                    <th data-i18n="bandwidth_top_usage_loading">
                                        Loading..
                                    </th>
                                </tbody>
                            </table>
                                ...
                                <form class="form form-vertical">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <button type="button" id="filter-data" class="btn btn-primary round mr-1 mb-1 waves-effect waves-light pull-right" data-i18n="bandwidth_top_usage_filter">Filter</button>
                                                <button type="reset" class="btn btn-danger round mr-1 mb-1 waves-effect waves-light pull-right" data-dismiss="modal" data-i18n="bandwidth_top_usage_cancel">Cancel</button>
                                            </div>
