    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="camp_click_title">Campaign Click Summary</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="camp_click_subtitle">
                                Campaign click summary
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-data" id="campaign-list">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="camp_click_no">No</th>
                                        <th data-i18n="camp_click_name">Campaign Name</th>
                                        <th data-i18n="camp_click_start_date">Start Date</th>
                                        <th data-i18n="camp_click_end_date">End Date</th>
                                        <th data-i18n="camp_click_trigger">Trigger</th>
                                        <th data-i18n="camp_click_target">Target</th>
                                        <th data-i18n="camp_click_source">Source</th>
                                        <th data-i18n="camp_click_click_thru">Total Click Thru</th>
                                        <th data-i18n="camp_click_unique_click">Total Unique Click</th>
                                        <th data-i18n="camp_click_status">Status</th>
                                        <th data-i18n="camp_click_action">Action</th>
                                    </tr>
                                </thead>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel16" data-i18n="camp_click_modal_title">Campaign Hourly View (<span class="chart-header-campaign"></span>)</h4>
            ...
            <div class="modal-body" style="overflow: auto;">
                ...
                <table id="data-details" class="table table-bordered">
                    <thead class="thead thead-light">
                        <tr>
                            <th>#</th>
                            <th data-i18n="camp_click_modal_date">Date</th>
                            <th data-i18n="camp_click_modal_clicked">Clicked</th>
                            <th data-i18n="camp_click_modal_unique_clicked">Unique Clicked</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
            ...
            <div class="modal-footer">
                <button class="btn btn-danger waves-effect waves-light btn-close" data-i18n="camp_click_modal_close">Close</button>
            </div>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group" style="position:relative; left:auto; display:block;">
                                                    <label for="startdate" data-i18n="camp_click_modal_date_from">Date From</label>
                                                    <input type="text" class="form-control format-picker" name="startdate" id="startdate" value='<?= report_date_view(report_date_start("", 2)) ?>'>
                                                </div>

                                                <div class="form-group" style="position:relative; left:auto; display:block;">
                                                    <label for="enddate" data-i18n="camp_click_modal_date_until">Date Until</label>
                                                    <input type="text" class="form-control format-picker" name="enddate" id="enddate" value='<?= report_date_view(report_date_start("", 1)) ?>'>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <button type="button" id="filter-data" class="btn btn-primary round mr-1 mb-1 waves-effect waves-light pull-right" data-i18n="camp_click_modal_filter">Filter</button>
                                                <button type="reset" class="btn btn-danger round mr-1 mb-1 waves-effect waves-light pull-right" data-dismiss="modal" data-i18n="camp_click_modal_cancel">Cancel</button>
                                            </div>
