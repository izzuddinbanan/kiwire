    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="title">Tejas / Sim Card</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="subtitle">
                                Manage Tejas / Sim Card
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="create-form" action="#" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary round waves-effect waves-light 
                    " data-i18n="modal_1_footer_button_create">Create</button>
