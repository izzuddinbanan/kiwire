...
$kiw['module'] = "Report -> Login Summary";
    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="login_logins_summary_title">Login Summary</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="login_logins_summary_subtitle">
                                Information on login transaction summary
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="login_logins_summary_no">No</th>
                                        <th data-i18n="login_logins_summary_date">Date</th>
                                        <th data-i18n="login_logins_summary_succeed">Succeed</th>
                                        <th data-i18n="login_logins_summary_failed">Failed</th>
                                        <th data-i18n="login_logins_summary_hourly_view">Hourly view</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel16" data-i18n="login_logins_summary_modal_title">Login Summary - Hourly</h4>
            ...
            <div class="modal-body" style="overflow: auto;">
                ...
                <table class="table table-bordered table-detail">
                    <thead class="thead thead-light">
                        <tr>
                            <th data-i18n="login_logins_summary_modal_hour">Hour</th>
                            <th data-i18n="login_logins_summary_modal_succeed">Succeed</th>
                            <th data-i18n="login_logins_summary_modal_failed">Failed</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
            ...
            <div class="modal-footer">
                <button class="btn btn-danger waves-effect waves-light" data-dismiss="modal" data-i18n="login_logins_summary_modal_close">Close</button>
            </div>
