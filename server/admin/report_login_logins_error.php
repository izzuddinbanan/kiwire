    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="login_logins_error_title">Login Error</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="login_logins_error_subtitle">
                                Information error encounter by users
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="login_logins_error_no">No</th>
                                        <th data-i18n="login_logins_error_date">Date</th>
                                        <th data-i18n="login_logins_error_msg">Error Message</th>
                                        <th data-i18n="login_logins_error_count">Count</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
                                ...
                                <form class="form form-vertical">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <button type="button" id="filter-data" class="btn btn-primary round mr-1 mb-1 waves-effect waves-light pull-right" data-i18n="login_logins_error_filter">Filter</button>
                                                <button type="reset" class="btn btn-danger round mr-1 mb-1 waves-effect waves-light pull-right" data-dismiss="modal" data-i18n="login_logins_error_cancel">Cancel</button>
                                            </div>
