    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="login_return_accounts_title">Return Account Summary</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="login_return_accounts_subtitle">
                                Information on new or repeat login
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="enddate" data-i18n="data_until">Zone</label>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="login_return_accounts_no">No</th>
                                        <th data-i18n="login_return_accounts_date">Date</th>
                                        <th data-i18n="login_return_accounts_login">Total Login</th>
                                        <th data-i18n="login_return_accounts_return_user">Total Return User</th>
                                        <th data-i18n="login_return_accounts_new_user">New User</th>
                                        <th data-i18n="login_return_accounts_hourly_view">Hourly view</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel16" data-i18n="login_return_accounts_modal_title">Login Summary - Hourly</h4>
            ...
            <div class="modal-body" style="overflow: auto;">
                ...
                <table class="table table-bordered table-detail">
                    <thead class="thead thead-light">
                        <tr>
                            <th data-i18n="login_return_accounts_modal_hour">Hour</th>
                            <th data-i18n="login_return_accounts_modal_login">Total Login</th>
                            <th data-i18n="login_return_accounts_modal_return_user">Return User</th>
                            <th data-i18n="login_return_accounts_modal_new_user">New User</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
            ...
            <div class="modal-footer">
                <button class="btn btn-danger waves-effect waves-light" data-dismiss="modal" data-i18n="login_return_accounts_modal_close">Close</button>
            </div>
