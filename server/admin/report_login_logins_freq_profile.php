...
$kiw['module'] = "Report -> Login Frequency -> Profile";
    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="login_logins_freq_profile_title">Login Frequency by Profile</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="login_logins_freq_profile_subtitle">
                                Information on login frequency & unique login by profile
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="login_logins_freq_profile_no">No</th>
                                        <th data-i18n="login_logins_freq_profile_date">Date</th>
                                        <th data-i18n="login_logins_freq_profile_profile_name">Profile Name</th>
                                        <th data-i18n="login_logins_freq_profile_total_login">Total Login</th>
                                        <th data-i18n="login_logins_freq_profile_unique_login">Unique Login ( Daily )</th>
                                        <th data-i18n="login_logins_freq_profile_hourly_view">Hourly View</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel16" data-i18n="login_logins_freq_profile_modal_title">Login Frequency By Profile - Hourly</h4>
            ...
            <div class="modal-body" style="overflow: auto;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div style="text-align:center;" id="detail-chart" style="min-height: 500px;"></div>
                    </div>
                </div>
                ...
                <table class="table table-bordered table-detail">
                    <thead class="thead thead-light">
                        <tr>
                            <th data-i18n="login_logins_freq_profile_modal_hour">Hour</th>
                            <th data-i18n="login_logins_freq_profile_modal_profile">Profile</th>
                            <th data-i18n="login_logins_freq_profile_modal_total_login">Total Login</th>
                            <th data-i18n="login_logins_freq_profile_modal_unique_login">Unique Login</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
            ...
            <div class="modal-footer">
                <button class="btn btn-danger waves-effect waves-light" data-dismiss="modal" data-i18n="login_logins_freq_profile_modal_close">Close</button>
            </div>
                                ...
                                <form class="form form-vertical">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <button type="button" id="filter-data" class="btn btn-primary round mr-1 mb-1 waves-effect waves-light pull-right" data-i18n="login_logins_freq_profile_modal_filter">Filter</button>
                                                <button type="reset" class="btn btn-danger round mr-1 mb-1 waves-effect waves-light pull-right" data-dismiss="modal" data-i18n="login_logins_freq_profile_modal_cancel">Cancel</button>
                                            </div>
