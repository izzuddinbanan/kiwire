...
$kiw['module'] = "Report -> Bandwidth vs Users";
    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="bandwidth_vs_user_title">Bandwidth vs Login</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="bandwidth_vs_user_subtitle">
                                Information on average bandwidth usage vs login
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="bandwidth_vs_user_no">No</th>
                                        <th data-i18n="bandwidth_vs_user_date">Date</th>
                                        <th><span data-i18n="bandwidth_vs_user_bandwidth">Bandwidth</span> ( <?= $_SESSION['metrics'] ?>ps )</th>
                                        <th data-i18n="bandwidth_vs_user_login">Login</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group" style="position:relative; left:auto; display:block;">
                                                    <label for="startdate" data-i18n="bandwidth_vs_user_data_from">Date From</label>
                                                    <input type="text" class="form-control format-picker" name="startdate" id="startdate" value='<?= report_date_view(report_date_start("", 2)) ?>'>
                                                </div>

                                                <div class="form-group" style="position:relative; left:auto; display:block;">
                                                    <label for="enddate" data-i18n="bandwidth_vs_user_data_until">Date Until</label>
                                                    <input type="text" class="form-control format-picker" name="enddate" id="enddate" value='<?= report_date_view(report_date_start("", 1)) ?>'>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <button type="button" id="filter-data" class="btn btn-primary round mr-1 mb-1 waves-effect waves-light pull-right" data-i18n="bandwidth_vs_user_filter">Filter</button>
                                                <button type="reset" class="btn btn-danger round mr-1 mb-1 waves-effect waves-light pull-right" data-dismiss="modal" data-i18n="bandwidth_vs_user_cancel">Cancel</button>
                                            </div>
