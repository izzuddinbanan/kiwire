    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="bandwidth_overall_usage_title">Bandwidth Usage</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="bandwidth_overall_usage_subtitle">
                                Information of overall bandwidth usage by your network
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="bandwidth_overall_usage_no">No</th>
                                        <th data-i18n="bandwidth_overall_usage_date">Date</th>
                                        <th><span data-i18n="bandwidth_overall_usage_download">Download </span>( <?= $_SESSION['metrics'] ?>ps )</th>
                                        <th><span data-i18n="bandwidth_overall_usage_upload">Upload </span>( <?= $_SESSION['metrics'] ?>ps )</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
