...
function update()
{
    ...
    if (in_array($_SESSION['permission'], array("w", "rw"))) {
        ...
        if($kiw_db->update("kiwire_signup_public", $data, "tenant_id = '$tenant_id'")){

            sync_logger("{$_SESSION['user_name']} updated Public Sign up setting", $_SESSION['tenant_id']);
    
            echo json_encode(array("status" => "success", "message" => "SUCCESS: Public Sign up setting saved", "data" => null));
        }
        else {
