...
<div class="content-wrapper">
    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="login_dwell_profile_title">Dwell Time by Profile</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="login_dwell_profile_subtitle">
                                Information on average dwell time of user by profile
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <!-- 
    <div class="row">
        <div class="col-12 mb-1" id="filter-btn">
            <button class="float-right btn btn-icon btn-primary btn-xs fa fa-filter"></button>
        </div>
    </div> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="profile" data-i18n="data_profile">Profile Name</label>
                                    <select class="select2 form-control" name="profile" id="profile">
                                        <option value="" data-i18n="login_dwell_profile_none">None</option>
                                        <?php
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="login_dwell_profile_no">No</th>
                                        <th data-i18n="login_dwell_profile_date">Date</th>
                                        <th data-i18n="login_dwell_profile_profile_name">Profile name</th>
                                        <th data-i18n="login_dwell_profile_average_dwell">Average Dwell Time ( Hour : Minute : Second )</th>
                                        <th data-i18n="login_dwell_profile_detail_view">Detail view</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel16" data-i18n="login_dwell_profile_modal_title">Login Dwell Time By Profile - Hourly</h4>
            ...
            <div class="modal-body" style="overflow: auto;">
                ...
                <table class="table table-bordered table-detail">
                    <thead class="thead thead-light">
                        <tr>
                            <th data-i18n="login_dwell_profile_modal_hour">Hour</th>
                            <th data-i18n="login_dwell_profile_modal_profile_name">Profile Name</th>
                            <th data-i18n="login_dwell_profile_modal_average_dwell">Average Dwell Time ( Hour : Minute : Second ) </th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
            ...
            <div class="modal-footer">
                <button class="btn btn-danger waves-effect waves-light" data-dismiss="modal" data-i18n="login_dwell_profile_modal_close">Close</button>
            </div>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="profile" data-i18n="data_profile">Profile Name</label>
                                                    <select class="select2 form-control" name="profile">
                                                        <option value="" data-i18n="login_dwell_profile_none">None</option>
                                                        <?php
