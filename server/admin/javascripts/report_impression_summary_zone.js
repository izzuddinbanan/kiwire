...
function pull_data()
{
    ...
    $.ajax({
        url: "ajax/ajax_report_impression_summary_zone.php",
        method: "POST",
        data: {
            ...
            if (data['status'] === "success") {
                ...
                if (data['data'].length > 0) {
                    ...
                    for (let x = 0; x < data['data'].length; x++) {
                        ...
                        if(data['data'][x]['impression'] !== undefined && data['data'][x]['impression'] !== null){

                            $("#totalimp").html(data['data'][x]['impression']);
                        ...
                        if(data['data'][x]['uniq'] !== undefined && data['data'][x]['uniq'] !== null){

                            $("#totaluniq").html(data['data'][x]['uniq']);

                        }

                        if(data['data'][x]['avg_uniq'] !== undefined && data['data'][x]['avg_uniq'] !== null){

                            $("#avguniq").html(data['data'][x]['avg_uniq']);
            ...
            if (data['status'] === "success") {
                ...
                if (data['data'].length > 0) {
                    ...
                    for (let x = 0; x < data['data'].length; x++) {
                        ...
                        chart_uniq.push([data['data'][x]['xreport_date'], data['data'][x]['uniq']]);
...
function get_report_per_date(report_date) {
    ...
    if (report_date.length > 0) {
        ...
        $.ajax({
            url: "/admin/ajax/ajax_report_impression_summary_zone.php",
            method: "get",
            data: {
