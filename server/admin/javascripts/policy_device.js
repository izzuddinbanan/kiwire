$(document).ready(function () {
    ...
    $(".btn-create").on("click", function (e) {
        ...
        if (create_form.parsley().validate()) {
            ...
            $.ajax({
                url: "ajax/ajax_policy_device.php?action=create",
                method: "GET",
                data: data,
    ...
    $(".btn-update").on("click", function (e) {
        ...
        if (create_form.parsley().validate()) {
            ...
            $.ajax({
                url: "ajax/ajax_policy_device.php?action=edit_single_data",
                method: "GET",
                data: data,
                success: function (data) {
...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_policy_device.php",
        method: "GET",
        data: {
            "action": "get_all"
        },
        success: function (data) {
            ...
            if (data['status'] === "success") {
                ...
                for (let x = 0; x < data['data'].length; x++) {
                    ...
                    table_str += "<td>" + data['data'][x]['zone'] + "</td>";
                    table_str += "<td>" + data['data'][x]['type'] + "</td>";
                    table_str += "<td>" + data['data'][x]['value'] + "</td>";
