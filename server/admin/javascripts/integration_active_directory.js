$(document).ready(function () {
    ...
    $("#main-tab").on("click", function () {
        ...
        $(".create-btn-ad").css("display", "none");
    ...
    $("#mapping-tab").on("click", function () {
        ...
        $(".create-btn-ad").css("display", "block");

    });


    $(".create-btn-ad").on("click", function () {
    ...
    $(".save-button").on("click", function (e) {
        ...
        $.ajax({
            url: "ajax/ajax_integration_active_directory.php?action=update",
            method: "POST",
            data: data,
    ...
    $(".btn-create").on("click", function (e) {
        ...
        if (create_form.parsley().validate()) {
            ...
            $.ajax({
                url: "ajax/ajax_integration_active_directory.php?action=create",
                method: "GET",
                data: data,
                success: function (data) {
    ...
    $(".btn-update").on("click", function (e) {
        ...
        $.ajax({
            url: "ajax/ajax_integration_active_directory.php?action=edit_single_data",
            method: "GET",
            data: data,
            success: function (data) {
...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_integration_active_directory.php",
        method: "GET",
        data: {
            "action": "get_all"
        },
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data) {
                    ...
                    $("#profile_group").val(data['data']['profile']);
                    $("#allowed_zone_group").val(data['data']['allowed_zone']);
...
$(".btn-test").on("click", function () {
    ...
    $.ajax({
        url: "/admin/ajax/ajax_integration_active_directory.php?action=test",
        method: "post",
        data: data,
