...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_report_impression_summary.php",
        method: "POST",
        data: {
        ...
        success: function (data) {
            ...
            if (data['status'] === "success") {
                ...
                $("#totalimp").html(data['data']['impression']);

                $("#avgimp").html((data['data']['impression'] / data['data']['hours']).toFixed(3));


                $("#totaluniq").html((data['data']['login_total'] / data['data']['hours']).toFixed(3));

                $("#avguniq").html(parseInt((data['data']['login_unique'] / data['data']['hours'])).toFixed(3));
            ...
            if (data['status'] === "success") {
                ...
                if (data['data'].length > 0) {
                    ...
                    for (let x = 0; x < data['data'].length; x++) {
                        ...
                        chart_uniq.push([data['data'][x]['xreport_date'], data['data'][x]['login_total']]);
...
function get_report_per_date(report_date) {
    ...
    if (report_date.length > 0) {
        ...
        $.ajax({
            url: "/admin/ajax/ajax_report_impression_summary.php",
            method: "get",
            data: {
            ...
            success: function (response) {
                ...
                if (response['status'] === "success") {
                    ...
                    for (let x = 0; x < response['data'].length; x++) {
                        ...
                        chart_uniq.push(response['data'][x]['login_total']);
