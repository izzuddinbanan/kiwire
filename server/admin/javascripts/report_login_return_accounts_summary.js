...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_report_login_return_accounts_summary.php",
        method: "POST",
        data: {
            ...
            if (data['status'] === "success") {
                ...
                if (data['data'].length > 0) {
                    ...
                    for (let x = 0; x < data['data'].length; x++) {
                        ...
                        table_str += "<td>" + data['data'][x]['return_user'] + "</td>";
                        table_str += "<td>" + data['data'][x]['new_user'] + "</td>";
                        ...
                        chart_return_user.push([(data['data'][x]['xreport_date']), (data['data'][x]['return_user'])]);
                        chart_new_user.push([(data['data'][x]['xreport_date']), (data['data'][x]['new_user'])]);
...
function get_report_per_date(report_date) {
    ...
    if (report_date.length > 0) {
        ...
        $.ajax({
            url: "/admin/ajax/ajax_report_login_return_accounts_summary.php",
            method: "get",
            data: {
            ...
            success: function (response) {
                ...
                if (response['status'] === "success") {
                    ...
                    for (let x = 0; x < response['data'].length; x++) {
                        ...
                        table_str += "<td>" + response['data'][x]['return_user'] + "</td>";
                        table_str += "<td>" + response['data'][x]['new_user'] + "</td>";
                        table_str += "</tr>";

                        chart_date.push(response['data'][x]['xreport_date']);
                        chart_total.push(parseInt(response['data'][x]['total']));
                        chart_return_user.push(parseInt(response['data'][x]['return_user']));
                        chart_new_user.push(parseInt(response['data'][x]['new_user']));
