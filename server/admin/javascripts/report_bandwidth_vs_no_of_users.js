...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_report_bandwidth_vs_no_of_users.php",
        method: "POST",
        data: {
            ...
            if (data['status'] === "success") {
                ...
                if (data['data'].length > 0) {
                    ...
                    for (let x = 0; x < data['data'].length; x++) {
                        ...
                        if (data['data'][x]['bandwidth'] === null) data['data'][x]['bandwidth'] = 0;
                        if (data['data'][x]['login'] === null) data['data'][x]['login'] = 0;


                        table_str += "<tr>";
                        table_str += "<td>" + (x + 1) + "</td>";
                        table_str += "<td>" + Date.parse(data['data'][x]['xreport_date']).toString("d-MMM-yyyy") + "</td>";
                        table_str += "<td>" + parseFloat(data['data'][x]['bandwidth']).toFixed(3) + "</td>";
                        table_str += "<td>" + data['data'][x]['login'] + "</td>";
                        table_str += "</tr>";

                        chart_bandwidth.push([(data['data'][x]['xreport_date']), (data['data'][x]['bandwidth'])]);
                        chart_users.push([(data['data'][x]['xreport_date']), (data['data'][x]['login'])]);
