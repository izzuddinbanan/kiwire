...
$(document).ready(function () {
        ...
        if (filter_role.length > 2) {
            ...
            if (filter_role !== ":title") {
                ...
                $("input[type=checkbox]").each(function (e) {
                    ...
                    console.log(current_item.val().toLowerCase().indexOf(filter_role));

                    if (current_item.val().toLowerCase().indexOf(filter_role) > 0) {
    ...
    $(".btn-create").on("click", function (e) {
        ...
        if (create_form.parsley().validate()) {
            ...
            $.ajax({
                url: "ajax/ajax_configuration_role.php?action=create",
                method: "POST",
                data: data,
...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_configuration_role.php",
        method: "GET",
        data: {
            "action": "get_all"
        },
