...
function pulldata_totalAvg() {
    ...
    $.ajax({
        url: "ajax/ajax_report_campaign_email_send_report.php",
        method: "POST",
        data: {
        ...
        success: function (data) {
            ...
            if (data['status'] === "success") {
                ...
                $("#total-email").html(data['data']['total']);

                $("#avg-email").html(parseFloat(data['data']['total'] / data['data']['hours']).toFixed(3));
            ...
            if (data['status'] === "success") {
                ...
                if (data['data'].length > 0) {
                    ...
                    for (let x = 0; x < data['data'].length; x++) {
                        ...
                        chart_total_email.push([data['data'][x]['xreport_date'], parseInt(data['data'][x]['total'])]);
                    }
