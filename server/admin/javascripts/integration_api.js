...
$(document).ready(function () {
    ...
    $(".btn-create").on("click", function (e) {
        ...
        if (create_form.parsley().validate()) {
            ...
            $.ajax({
                url: "ajax/ajax_integration_api.php?action=create",
                method: "GET",
                data: data,
    ...
    $(".btn-update").on("click", function (e) {
        ...
        $.ajax({
            url: "ajax/ajax_integration_api.php?action=edit_single_data",
            method: "GET",
            data: data,
            success: function (data) {
...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_integration_api.php",
        method: "GET",
        data: {
            "action": "get_all"
        },
        success: function (data) {
            ...
            if (data['status'] === "success") {
                ...
                for (let x = 0; x < data['data'].length; x++) {
                    ...
                    table_str += "<td>" + (x + 1) + "</td>";
                    table_str += "<td>" + data['data'][x]['api_key'] + "</td>";
                    ...
                    table_str += "<td>" + data['data'][x]['module'].capitalize() + "</td>";
...
$(document).ready(function () {
    ...
    $('#copyAuthKey').copyToClipboard('#api_key');
...
function genKey() {
    ...
    $.ajax({
        ...
        method: "POST",
        url: "/admin/ajax/ajax_integration_api.php?action=genkey",
        data: {},
