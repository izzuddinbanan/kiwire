$(document).ready(function () {
    ...
    $(".create-btn-wallgarden").on("click", function () {
    ...
    $(".btn-create").on("click", function (e) {
        ...
        if (create_form.parsley().validate()) {
            ...
            $.ajax({
                url: "ajax/ajax_policy_wallgarden.php?action=create",
                method: "GET",
                data: data,
    ...
    $(".btn-update").on("click", function (e) {
        ...
        $.ajax({
            url: "ajax/ajax_policy_wallgarden.php?action=edit_single_data",
            method: "GET",
            data: data,
            success: function (data) {
...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_policy_wallgarden.php",
        method: "GET",
        data: {
            "action": "get_all"
        },
