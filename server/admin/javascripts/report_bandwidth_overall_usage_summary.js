...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_report_bandwidth_overall_usage_summary.php",
        method: "POST",
        data: {
            ...
            if (data['status'] === "success") {
                ...
                if (data['data'].length > 0) {
                    ...
                    for (let x = 0; x < data['data'].length; x++) {
                        ...
                        if (data['data'][x]['quota_out'] === null) data['data'][x]['quota_out'] = 0;
                        if (data['data'][x]['quota_in'] === null) data['data'][x]['quota_in'] = 0;
                        ...
                        chart_download.push([(data['data'][x]['xreport_date']), (parseFloat(data['data'][x]['quota_out']).toFixed(3))]);
                        chart_upload.push([(data['data'][x]['xreport_date']), (parseFloat(data['data'][x]['quota_in']).toFixed(3))]);
