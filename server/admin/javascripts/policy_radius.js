$(document).ready(function () {
    ...
    $(".create-btn-radiusattr").on("click", function () {
    ...
    $(".btn-create").on("click", function (e) {
        ...
        if (create_form.parsley().validate()) {
            ...
            $.ajax({
                url: "ajax/ajax_policy_radius.php?action=create",
                method: "GET",
                data: data,
    ...
    $(".btn-update").on("click", function (e) {
        ...
        $.ajax({
            url: "ajax/ajax_policy_radius.php?action=edit_single_data",
            method: "GET",
            data: data,
            success: function (data) {
...
function pull_data() {
    ...
    $.ajax({
        url: "ajax/ajax_policy_radius.php",
        method: "GET",
        data: {
            "action": "get_all"
        },
        success: function (data) {
            ...
            if (data['status'] === "success") {
                ...
                for (let x = 0; x < data['data'].length; x++) {
                    ...
                    table_str += "<td>" + (x + 1) + "</td>";
                    table_str += "<td>" + data['data'][x]['plan'] + "</td>";
                    table_str += "<td>" + data['data'][x]['attribute'] + "</td>";
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (data){
                    ...
                    $("#attribute").val(data['data']['attribute']);
                    $("#op").val(data['data']['op']);
