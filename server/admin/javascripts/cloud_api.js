$(document).ready(function () {
    ...
    $(".btn-create").on("click", function (e) {
        ...
        if (create_form.parsley().validate()) {
            ...
            $.ajax({
                url: "ajax/ajax_cloud_api.php?action=create",
                method: "GET",
                data: data,
    ...
    $(".btn-update").on("click", function (e) {
        ...
        $.ajax({
            url: "ajax/ajax_cloud_api.php?action=edit_single_data",
            method: "GET",
            data: data,
            success: function (data) {
        ...
        success: function (data) {
            ...
            if (data['status'] === "success") {
                ...
                for (let x = 0; x < data['data'].length; x++) {
                    ...
                    table_str += "<td>" + data['data'][x]['module'] + "</td>";
...
function genKey() {
    ...
    $.ajax({
        ...
        method: "POST",
        url: "/admin/ajax/ajax_cloud_api.php?action=genkey",
        data: {},
