...
function get_data_for_all() {
    ...
    $.ajax({
        url: "/admin/ajax/ajax_report_campaign_camp_impression_summary.php",
        method: "post",
        data: {
            ...
            if (response['status'] === "success") {
                ...
                if (response['data'] !== null) {
                    ...
                    for (let kindex in response['data']) {
                        ...
                        campaign_list += "<td>" + response['data'][kindex]['impress'] + "</td>";
                        campaign_list += "<td>" + response['data'][kindex]['u_impress'] + "</td>";
                                        ...
                                        if (response['status'] === "success") {
                                            ...
                                            if (response['data'] != null) {
                                                ...
                                                for (let kindex in response['data']['date']) {
                                                    ...
                                                    campaign_list += "<td>" + response['data']['impress'][kindex] + "</td>";
                                                    campaign_list += "<td>" + response['data']['u_impress'][kindex] + "</td>";
                                                    campaign_list += "</tr>";

                                                    impress_data.push([response['data']['date'][kindex], parseInt(response['data']['impress'][kindex]).toFixed(0)]);
                                                    uimpress_data.push([response['data']['date'][kindex], parseInt(response['data']['u_impress'][kindex]).toFixed(0)]);
