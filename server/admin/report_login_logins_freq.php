...
$kiw['module'] = "Report -> Login Frequency Summary";
    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="login_logins_freq_title">Login Frequency</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="login_logins_freq_subtitle">
                                Information on login frequency & unique login
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="login_logins_freq_no">No</th>
                                        <th data-i18n="login_logins_freq_date">Date</th>
                                        <th data-i18n="login_logins_freq_login">Total Login</th>
                                        <th data-i18n="login_logins_freq_unique_daily">Unique Login ( Daily )</th>
                                        <th data-i18n="login_logins_freq_unique_forever">Unique Login ( Forever )</th>
                                        <th data-i18n="login_logins_freq_hourly_view">Hourly View</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel16" data-i18n="login_logins_freq_modal_title">Login Frequency - Hourly</h4>
            ...
            <div class="modal-body" style="overflow: auto;">
                ...
                <table class="table table-bordered table-detail">
                    <thead class="thead thead-light">
                        <tr>
                            <th data-i18n="login_logins_freq_modal_hour">Hour</th>
                            <th data-i18n="login_logins_freq_modal_login">Total Login</th>
                            <th data-i18n="login_logins_freq_modal_unique_daily">Unique Login ( Daily )</th>
                            <th data-i18n="login_logins_freq_modal_unique_forever">Unique Login ( Forever )</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
            ...
            <div class="modal-footer">
                <button class="btn btn-danger waves-effect waves-light" data-dismiss="modal" data-i18n="login_logins_freq_modal_close">Close</button>
            </div>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" id="filter-data" class="btn btn-primary round mr-1 mb-1 waves-effect waves-light pull-right" data-i18n="login_logins_freq_modal_filter">Filter</button>
                                                    <button type="reset" class="btn btn-danger round mr-1 mb-1 waves-effect waves-light pull-right" data-dismiss="modal" data-i18n="login_logins_freq_modal_cancel">Cancel</button>
                                                </div>
