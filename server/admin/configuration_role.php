    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="title">Role</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="subtitle">
                                Manage role for administrator
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="card-text">
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-light btn-add pull-right" data-toggle="modal" data-i18n="btn_add_role">Add Role</button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form class="create-form" action="#">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-md-12">
                                                <span data-i18n="modal_1_role_name">Role Name:</span> <span class="text-danger">*</span>
                                            ...
                                            <div class="col-md-12 mb-5">
                                                <span data-i18n="modal_1_allow_access"> Allow Access:</span>

                                                <button type="button" class="btn btn-primary pull-right mr-2 btn-select-all" data-i18n="modal_1_btn_select_all">
                                                    Select All
                                                </button>
                                                <button type="button" class="btn btn-primary pull-right mr-2 btn-clear-all" data-i18n="modal_1_btn_clear_all">Clear
                                                    All
                                                </button>
                                            ...
                                            <div class="col-md-12 p-1 border role-list" style="max-height: 300px; min-height: 300px; overflow: auto;">
                                                ...
                                                foreach ($list_group_mod as $group_mod) {
                                                    ...
                                                    if (strtolower($group_mod['ccount']) != "cloud") {
                                                        ...
                                                        foreach ($kiw_row as $value) {
                                                            ...
                                                            if(!in_array($value['moduleid'], array('Device -> Monitoring -> Dashboard'))){
