    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0 text-uppercase" data-i18n="monitoring_report_title">Controller Report</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" data-i18n="monitoring_report_subtitle">
                                View information of controller
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-hover table-data">
                                <thead>
                                    <tr class="text-uppercase">
                                        <th data-i18n="monitoring_report_no">No</th>
                                        <th data-i18n="monitoring_report_date">Report Date</th>
                                        <th data-i18n="monitoring_report_total">Total</th>
                                        <th data-i18n="monitoring_report_running">Running</th>
                                        <th data-i18n="monitoring_report_count">Incident count</th>
                                        <th data-i18n="monitoring_report_issue">issue</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group" style="position:relative; left:auto; display:block;">
                                                    <label for="startdate" data-i18n="monitoring_report_modal_date_from">Date From</label>
                                                    <input type="text" class="form-control format-picker" name="startdate" id="startdate" value='<?= report_date_view(report_date_start("", 2)) ?>'>
                                                </div>

                                                <div class="form-group" style="position:relative; left:auto; display:block;">
                                                    <label for="enddate" data-i18n="monitoring_report_modal_date_until">Date Until</label>
                                                    <input type="text" class="form-control format-picker" name="enddate" id="enddate" value='<?= report_date_view(report_date_start("", 1)) ?>'>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <button type="button" id="filter-data" class="btn btn-primary round mr-1 mb-1 waves-effect waves-light pull-right" data-i18n="monitoring_report_modal_filter">Filter</button>
                                                <button type="reset" class="btn btn-danger round mr-1 mb-1 waves-effect waves-light pull-right" data-dismiss="modal" data-i18n="monitoring_report_modal_cancel">Cancel</button>
                                            </div>
