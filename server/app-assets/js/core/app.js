...
// custom init script to make life easier for menu management

$("li>a").each(function(){

  let pathViewing = window.location.href;

  pathViewing = pathViewing.split("/");
  pathViewing = pathViewing[pathViewing.length - 1];

  if (pathViewing.indexOf("#") > 0){

    pathViewing = pathViewing.substr(0, pathViewing.length - 1);

  }


  let pageViewing = $(this).attr("href");

  if (pageViewing) {

    if (pageViewing.search("php") > 0){

      if (pathViewing === pageViewing){
