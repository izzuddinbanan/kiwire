...
$kiw_temp = $kiw_cache->get("RADIUS_DATA:{$_SESSION['controller']['tenant_id']}");

if (empty($kiw_temp)) {


    $kiw_temp = $kiw_db->query_first("SELECT SQL_CACHE * FROM kiwire_int_radius WHERE enabled = 'y' AND tenant_id = '{$_SESSION['controller']['tenant_id']}' LIMIT 1");
