...
$kiw_row = $kiw_db->query_first("SELECT * FROM  kiwire_int_sms WHERE tenant_id = '{$tenant_id}' LIMIT 1");

if (empty($kiw_row)) $kiw_db->query("INSERT INTO  kiwire_int_sms(tenant_id) VALUE('{$tenant_id}')");
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-content">
                            ...
                            <div class="card-header pull-right">
                                <button type="button" class="btn btn-primary save-button waves-effect waves-light" data-i18n="integration_sms_save">
                                    Save
                                </button>
                                ...
                                <form class="update-form">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="basic" aria-labelledby="basic-tab" role="tabpanel">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select name="operator" class="select2 form-control change-provider" data-for="sms-test" data-style="btn-default">
                                                            ...
                                                            <option value="cybernet" <?= (($kiw_row['operator'] == "cybernet") ? " selected" : ""); ?>>
                                                                Cybernet
                                                            </option>
                                                        </select>
                                                    </div>
                                            ...
                                            <!--                                                <div class="form-group row">-->
                                            <!--                                                    <div class="text-right col-md-3">-->
                                            <!--                                                        <span>Use Whatsapp Instead of SMS</span>-->
                                            <!--                                                    </div>-->
                                            <!--                                                    -->
                                            <!--                                                    <div class="col-md-7">-->
                                            <!--                                                        -->
                                            <!--                                                        <div class="custom-control custom-switch custom-control-inline">-->
                                            <!--                                                            <input type="checkbox" class="custom-control-input" name="twilio_use_whatsapp" id="twilio_use_whatsapp" --><? //= ($kiw_row['twilio_use_whatsapp'] == "y") ? 'checked="yes"' : ''
                                                                                                                                                                                                                        ?>
                                            <!--value="y" class="toggle"/>-->
                                            <!--                                                            <label class="custom-control-label" for="twilio_use_whatsapp"></label>-->
                                            <!--                                                        </div>-->
                                            <!--                                                        -->
                                            <!--                                                    </div>-->
                                            <!--                                                    -->
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="text-right col-md-3">
                                                        <span data-i18n="integration_sms_validity">Validity</span>
                                                    </div>
                                                    <div class="col-md-7">
        ...
        <div class="modal-content">
            ...
            <form class="create-form" action="#">
                ...
                <div class="modal-body">
                    ...
                    <label data-i18n="integration_sms_country2">Country: </label>
                    <div class="form-group">
                        <input type="text" name="country" id="country" value="" class="form-control" required>
                    </div>

                    <label data-i18n="integration_sms_prefix3">Prefix: </label>
                    <div class="form-group">
                        <input type="text" name="prefix" id="prefix" value="" class="form-control" required>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12 sms-respond-space" style="height: 50px;">
                            &nbsp;
                        </div>
                    </div>
