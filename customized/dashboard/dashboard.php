                                ...
                                <div class="card-body">
                                    ...
                                    <table width="100%">
                                        <tr style="text-align: center;">
                                            <td>
                                                <h5 class="text-white" id="current-cpu-usage_1" style="font-size: xx-large; font-weight: bolder;" >0</h5>
                                            </td>
                                            <td>
                                                <h5 class="text-white" id="current-cpu-usage_2" style="font-size: xx-large; font-weight: bolder;" >0</h5>
                                            </td>
                                            <td>
                                                <h5 class="text-white" id="current-cpu-usage_3" style="font-size: xx-large; font-weight: bolder;" >0</h5>
                                            </td>
                                        </tr>
                                        <tr  style="text-align: center;">
                                            <td> LAST 1 MIN</td>
                            ...
                            <div class="card text-white bg-gradient-info">
                                <div class="card-content d-flex">
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-white"  style="font-size: xx-large; font-weight: bolder;"><span id="current-memory-usage" >0</span> %</h5>
                            ...
                            <div class="card text-white bg-gradient-info">
                                <div class="card-content d-flex">
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-white"  style="font-size: xx-large; font-weight: bolder;"><span id="current-disk-usage">0</span> %</h5>
