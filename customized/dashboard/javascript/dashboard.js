    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response['status'] === "success"){
                ...
                $("#current-cpu-usage_1").html(parseFloat(response['data']['cpu_used'][0]).toFixed(2));
                $("#current-cpu-usage_2").html(parseFloat(response['data']['cpu_used'][1]).toFixed(2));
                $("#current-cpu-usage_3").html(parseFloat(response['data']['cpu_used'][2]).toFixed(2));
