...
box_out "Kiwire v3 - Installer - Built 2021 - Rocky Linux"

centos_version=$(cat /etc/rocky-release | awk '{print $4}' | cut -d '.' -f 1)
...
systemctl enable mariadb radiusd redis php-fpm nginx kiwire_integration kiwire_service kiwire_report
...
# update column
box_out "Migration new table/columm"

/usr/bin/php /var/www/kiwire/system/migrations/index.php


box_out "Restructure DB to new version"
/usr/bin/php /var/www/kiwire/system/utils/restructure_db.php
...
chmod 755 -R /var/www/kiwire/server/temp
